...
class Board:
    ...
    def autoplay(self):
        ...
        #TODO: Modify player1 to be use MCTS instead of Randplay
            ...
            player1 = MinimaxTree(copy.deepcopy(self.grid),self.piece, self.preRow, self.preCol ) #pass gridboard and who play to the minimax algorithm
            r,c =    player1.next_step();
        ...
        if not self.game_over:
            ...
            #fetch the position of white chess piece
            self.row = r
            self.col = c
            print("Auto", self.piece, "move: (", r, ",", c, ")")
            self.preRow = r;
    ...
    def semi_autoplay(self):
        if not self.game_over:
            ...
            # player1 = Randplay(self.grid, self.piece)
            # r,c = player1.make_move()
            #next step is self.piece play
            player1 = MinimaxTree(copy.deepcopy(self.grid), self.piece, self.preRow, self.preCol)
            r, c = player1.next_step();
